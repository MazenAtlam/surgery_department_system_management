...
class Config:
    SECRET_KEY = (
            ...
            "m6Mqvd1RWQE6v3WdYnHUHfBNXHxOxLoSWhj-PW8Z0e"
    )
    ...
    HOST = (
            ...
            "ep-misty-poetry-a21sokc7-pooler.eu-central-1.aws.neon.tech"
    )
    ...
    JWT_SECRET_KEY = (
            ...
            "ereteyubcgdhfjmazensherifahmedmostafaanas##$$%^djyfgjidigp0-ititjgj"
    )
