...
def upgrade():
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('deleted_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['pic_id'], ['uploaded_files.id'], ),
    ...
    with op.batch_alter_table('admins', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_admins_user_id'), ['user_id'], unique=False)
    ...
    with op.batch_alter_table('medical_history', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_medical_history_name'), ['name'], unique=False)
    ...
    sa.Column('deleted_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['department_id'], ['departments.id'], ),
    sa.ForeignKeyConstraint(['room_device_id'], ['medical_devices.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    with op.batch_alter_table('working_slots', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_working_slots_doctor_id'), ['doctor_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_working_slots_end_time'), ['end_time'], unique=False)
        batch_op.create_index(batch_op.f('ix_working_slots_id'), ['id'], unique=False)
        batch_op.create_index(batch_op.f('ix_working_slots_start_time'), ['start_time'], unique=False)
